...
module.exports = function (config) {
  ...
  return {
    ...
    updateUserByUUid: function (uuid, body) {
      return reqInstanceWithBody('PUT', '/users/me/user/' + uuid, body)
    },

    createUserByUUid: function (body) {
      return reqInstanceWithBody('POST', '/users/me/user/', body)
    },
    ...
    updateVerificationData: function (body, userUuid) {
      return reqInstanceWithBody('PATCH', '/users/' + userUuid + '/verify', body);
    },
